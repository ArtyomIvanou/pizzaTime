...
const Content = (props) => {
   ...
   return (
        <div className={'content'}>
            <Carousel ></Carousel>
            <Route exact path="/" ><Pizza content={props.content} addToCart={props.addToCart} changeSize={props.changeSize} changeDough={props.changeDough} cart={props.cart}/></Route>
            <Route path={'/pizza/'} ><Pizza content={props.content} addToCart={props.addToCart} changeSize={props.changeSize} changeDough={props.changeDough} cart={props.cart}/></Route>
