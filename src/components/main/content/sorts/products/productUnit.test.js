// import cartReducer, { addToCart } from "../../../../../redux/cart-reducer";
import itemReducer, { selectDough } from "../../../../../redux/configurate-item-reducer";
...
describe('ProdUnit', () => {
    ...
    //     let cartState = cartReducer(initialCartState, action)


    // test('смена размера товара в меню магазина', () => {

    //     let newAction = selectSize('small', 'pizza', newAnswer)
    //     let newState = itemReducer(initialState, newAction)
    //     let result = newState[0].products[5].config.defaultSize
    //     expect(result).toBe('small')

    // });
    // test('смена теста и борта в меню магазина', () => {

    //     let newAction = selectDough('cheese', 'pizza', newAnswer)
    //     let newState = itemReducer(initialState, newAction)
    //     let result = newState[0].products[5].config.defaulDough
    ...
    test('Link changes the class when hovered', () => {
        ...
        const component = TestRenderer.create(
            <ProductUnit content={product}/>,
        );
        let tree = component.toJSON();
        expect(tree).toMatchSnapshot();
        // console.log(tree.children)
        // manually trigger the callback
       let action= selectDough('cheese', 'pizza', product)
