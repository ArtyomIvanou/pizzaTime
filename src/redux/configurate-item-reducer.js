...
export const addToShop = (selectedType, value) => {
    return { type: ADD_TO_SHOP, selectedType: selectedType, value: value }
}
export const getShop = (type) => (dispatch) => {
    dispatch(isLoading(true))
    shopAPI.getProducts(type)
        .then(res => {
